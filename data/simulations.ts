...
export const simulations: Record<string, SimulationResult> = {
  ...
  TRUMP: {
    ...
    agentsCount: 20,
    clusters: {
      degen: { bullish: 4, neutral: 1, bearish: 0, sentiment: "BULLISH" },
      ...
      community: { bullish: 4, neutral: 1, bearish: 0, sentiment: "BULLISH" },
    },
    risks: "institutional mixed on regulatory; 2 agent timeouts",
    signals: "18/20 BUY consensus; STRONG_BUY from degen cluster; 95 composite score; exceptional volume-to-MC ratio",
    simulatedAt: "2026-03-20T17:15:00Z",
  },
  CHIBI: {
    ticker: "CHIBI",
    name: "Chibi",
    ...
    risks: "No major risks identified; all clusters aligned",
    signals: "20/20 completed; 18 BUY + 2 NEUTRAL; 91 composite score; strong safety (25/30) + wallet (25/30); PROCEED recommendation",
    simulatedAt: "2026-03-20T17:24:00Z",
  },
  BANANAS31: {
    ticker: "BANANAS31",
